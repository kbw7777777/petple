...
class SearchPage extends StatelessWidget implements HasLayoutGroup {
  SearchPage({Key key, this.layoutGroup, this.onLayoutToggle}) : super(key: key);
